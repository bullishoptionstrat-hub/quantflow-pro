...
// Vendored from @quantflow/domain (packages/domain/src/freshness.ts) by scripts/sync-vendored.mjs.
 ...
 */
import type { Quality, QualityFlag } from "./quality";
import type { Cadence } from "./provenance";
